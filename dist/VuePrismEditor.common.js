...
/* harmony default export */ var Editorvue_type_script_lang_js_ = ({
      ...
      handler: function handler(newVal) {
        if (!newVal) {
          ...
          if (this.codeLineCount) {
            this.codeData = newVal.split(/\r\n|\n/).slice(this.codeFirstLine - 1, this.codeFirstLine + this.codeLineCount - 1).join("\n");
          } else {
  ...
  computed: {
    ...
    lineNumbersCount: function lineNumbersCount() {
      var totalLines = this.codeData.split(/\r\n|\n/).length; // TODO: Find a better way of doing this - ignore last line break (os specific etc.)
